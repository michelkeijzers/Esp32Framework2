...
class MockIEspHttpServer : public IEspHttpServer {
   public:
    ...
    MOCK_METHOD(esp_err_t, httpd_resp_send_chunk, (httpd_req_t *, const char *, ssize_t),
                (override));
    MOCK_METHOD(esp_err_t, httpd_resp_send_404, (httpd_req_t *), (override));
    MOCK_METHOD(esp_err_t, httpd_register_uri_handler, (httpd_handle_t, const httpd_uri_t *),
                (override));
};
