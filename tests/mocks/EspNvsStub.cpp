...
esp_err_t EspNvs::nvs_get_i32(nvs_handle_t, const char *, int32_t *out_value) {
...
esp_err_t EspNvs::nvs_get_u32(nvs_handle_t, const char *, uint32_t *out_value) {
    if (out_value != nullptr) {
        *out_value = 0;
    }
    return ESP_OK;
...
esp_err_t EspNvs::nvs_get_i64(nvs_handle_t, const char *, int64_t *out_value) {
    if (out_value != nullptr) {
        *out_value = 0;
    }
    return ESP_OK;
...
esp_err_t EspNvs::nvs_get_u64(nvs_handle_t, const char *, uint64_t *out_value) {
    if (out_value != nullptr) {
        *out_value = 0;
    }
    return ESP_OK;
...
esp_err_t EspNvs::nvs_get_str(nvs_handle_t, const char *, char *out_value, size_t *length) {
    if (out_value != nullptr && length != nullptr && *length > 0) {
        out_value[0] = '\0';
    }
    return ESP_OK;
}

esp_err_t EspNvs::nvs_get_blob(nvs_handle_t, const char *, void *, size_t *) { return ESP_OK; }
