...
{
    uint32_t v = UriParamExtractor::extractFirstParamAsUint32(
        "/api/v1/presets/*", "/api/v1/presets/123");
    EXPECT_EQ(123u, v);
}
...
{
    uint32_t v = UriParamExtractor::extractFirstParamAsUint32(
        "/api/v1/presets/*", "/api/v1/presets/0");
    EXPECT_EQ(0u, v);
}
...
{
    uint32_t v = UriParamExtractor::extractFirstParamAsUint32(
        "/api/v1/presets/*", "/api/v1/presets/abc");
    EXPECT_EQ(0u, v);
}
...
{
    uint32_t v = UriParamExtractor::extractFirstParamAsUint32(
        "/api/v1/presets/*", "/api/v1/presets/65535");
    EXPECT_EQ(65535u, v);
}
