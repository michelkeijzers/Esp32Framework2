...
TEST_F(PresetManagerTest, GetPresetsEmptyInitially) { EXPECT_TRUE(pm.get_presets().empty()); }
...
TEST_F(PresetManagerTest, GetPresetNotFoundReturnsNull) { EXPECT_EQ(nullptr, pm.get_preset(99)); }
...
TEST_F(PresetManagerTest, BlackoutReturnsOk) { EXPECT_EQ(ESP_OK, pm.blackout()); }
