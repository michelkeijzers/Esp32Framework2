...
esp_err_t EspHttpServer::httpd_stop(httpd_handle_t)
{
    return ESP_OK;
}

int EspHttpServer::httpd_req_recv(httpd_req_t *, char *, size_t)
{
    return 0;
}
...
esp_err_t EspHttpServer::httpd_resp_send_404(httpd_req_t *)
{
    return ESP_OK;
}
