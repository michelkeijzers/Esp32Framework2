...
MasterTask::MasterTask(IFreeRtosFactory &freeRtosFactory, IMasterBridge &masterBridge,
                       IRtosQueue &masterBridgeQueue, IWebServerTask &webServerTask,
                       IRtosQueue &webServerQueue, IRtosQueueSet &queueSet, const char *taskName,
    ...
    : RtosTask(freeRtosFactory, taskName, stackSize, taskPriority),
      ...
      masterBridgeQueue_(masterBridgeQueue),
      webServerTask(webServerTask),
      webServerQueue_(webServerQueue),
      queueSet_(queueSet) {}
