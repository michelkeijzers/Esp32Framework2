...
ApiServer::ApiServer(IEspFactory &espFactory, ICommonApiFactory &commonApiFactory,
                     const NodesStaticInfo &nodesStaticInfo)
...
void ApiServer::register_generic_endpoints() {
    ...
    httpd_uri_t status_stream_uri = {.uri = "/api/v1/status/stream",
                                     .method = HTTP_GET,
                                     .handler = status_stream_handler_static,
                                     .user_ctx = static_cast<void *>(&apiStatus_)};
    espHttpServer_.httpd_register_uri_handler(server, &status_stream_uri);

    httpd_uri_t nodes_info_uri = {.uri = "/api/v1/nodes_info",
                                  .method = HTTP_GET,
    ...
    httpd_uri_t factory_reset_uri = {.uri = "/api/v1/factory_reset",
                                     .method = HTTP_POST,
                                     .handler = factory_reset_handler_static,
                                     .user_ctx = static_cast<void *>(&apiSystem_)};
    espHttpServer_.httpd_register_uri_handler(server, &factory_reset_uri);

    httpd_uri_t firmware_chunk_uri = {.uri = "/api/v1/firmware_chunk/*",
                                      .method = HTTP_POST,
    ...
    httpd_uri_t firmware_finish_uri = {.uri = "/api/v1/firmware_finish/*",
                                       .method = HTTP_POST,
                                       .handler = firmware_finish_handler_static,
                                       .user_ctx = static_cast<void *>(&apiFirmware_)};
    espHttpServer_.httpd_register_uri_handler(server, &firmware_finish_uri);

    httpd_uri_t esp_now_key_uri = {.uri = "/api/v1/esp_now_key",
                                   .method = HTTP_POST,
