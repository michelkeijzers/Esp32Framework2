...
MasterServiceTasks::MasterServiceTasks(IFreeRtosFactory& freeRtosFactory,
                                       NodeStaticInfo& nodeStaticInfo, int nodeOffset)
...
ILoggingTask& MasterServiceTasks::getLoggingTask() { return serviceTasks_.getLoggingTask(); }

IOtaTask& MasterServiceTasks::getOtaTask() { return serviceTasks_.getOtaTask(); }

IStatusTask& MasterServiceTasks::getStatusTask() { return statusTask_; }
