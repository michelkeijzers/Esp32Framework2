...
int EspHttpServer::httpd_req_recv(httpd_req_t *r, char *buf, size_t buf_len) {
    return httpd_req_recv(r, buf, buf_len);
}
...
esp_err_t EspHttpServer::httpd_resp_send_404(httpd_req_t *req) { return httpd_resp_send_404(req); }
