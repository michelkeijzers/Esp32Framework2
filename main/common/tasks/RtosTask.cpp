...
esp_err_t RtosTask::init() { return ESP_OK; }
...
esp_err_t RtosTask::start() {
    if (freeRtosFactory_.createTask(
            ...
            name_, stackSize_ / sizeof(StackType_t), this, priority_, nullptr) != pdPASS) {
        return ESP_FAIL;
    }
...
TickType_t RtosTask::getTickCount() { return freeRtosFactory_.getTickCount(); }
